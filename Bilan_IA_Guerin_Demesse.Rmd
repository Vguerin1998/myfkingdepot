...
op <- par(bg = "lightgrey", fg = "white", lwd = 2)
 ...
 plot(models$Nombre.d.images.de.test, models$Pourcentage.de.réussite,  
     pch = 20, cex = 0.8, col = "red", 
     xlab = "Nombre d'images de test",
     ylab = "% de réussite")

lines(lowess(models$Nombre.d.images.de.test, models$Pourcentage.de.réussite), col = "black")
title("% de réussite en fonction du nombre d'images de test") 
```
...
plot(models$Nombre.d.images.d.entraînement, models$Pourcentage.de.réussite,  
     pch = 20, cex = 0.8, col = "red", 
     xlab = "Nombre d'images d'entraînement",
     ylab = "% de réussite")

lines(lowess(models$Nombre.d.images.d.entraînement, models$Pourcentage.de.réussite), col = "black")
title("% de réussite en fonction du nombre d'images d'entraînement") 
```
